...
class BNE:
    def __init__(self, session, pretrained_we, params):
        ...
        variables = [_ for _ in tf.compat.v1.global_variables() if _ not in self.encoder.ignored_vars]
        ...
        emb_holder = tf.compat.v1.placeholder(tf.float32, [len(emb), params['we_dim']])
